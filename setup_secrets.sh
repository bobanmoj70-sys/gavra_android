...
gh secret set ANDROID_AGCONNECT_SERVICES_JSON_BASE64 < temp_secrets/ANDROID_AGCONNECT_SERVICES_JSON_BASE64.txt && echo "✓ ANDROID_AGCONNECT_SERVICES_JSON_BASE64"
...
gh secret set IOS_ENV < temp_secrets/IOS_ENV.txt && echo "✓ IOS_ENV"
