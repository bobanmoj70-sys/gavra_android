...
class _FinTr {
  static final Map<String, Map<String, String>> _t = AppTranslations.ns('finansijeScreen');
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildPeriodCard(
                      icon: '📊',
                      naslov: '${_FinTr.tr('ovaGodina')} (${iz.godinaBroj})',
                      podnaslov: _FinTr.tr('ceoGodisnjiBilans'),
                      prihod: iz.prihodGodina,
                      troskovi: iz.trosakGodina,
                      voznjiLabel: '${iz.voznjiGodina} ${_FinTr.tr('uplata')}',
                      color: Colors.grey,
                    ),
                    const SizedBox(height: 16),
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        items: _krediti
                            .map((k) => DropdownMenuItem(
                                  value: k.id,
                                  child: Text('${k.naziv} (${_fmtIznos(k.preostalo)} ${_FinTr.tr('preostaloLower')})'),
                                ))
                            .toList(),
