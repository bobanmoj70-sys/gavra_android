...
class _V3SmsLoginScreenState extends State<V3SmsLoginScreen> {
  ...
  static const Map<String, Map<String, String>> _t = {
    'prijava': {'sr': 'Prijava', 'en': 'Login', 'ru': 'Вход', 'de': 'Anmeldung'},
    'unesitePhone': {
    ...
    'brojTelefona': {'sr': 'Broj telefona', 'en': 'Phone number', 'ru': 'Номер телефона', 'de': 'Telefonnummer'},
    'nalepi': {'sr': 'Nalepi', 'en': 'Paste', 'ru': 'Вставить', 'de': 'Einfügen'},
    'nastavi': {'sr': 'Nastavi', 'en': 'Continue', 'ru': 'Продолжить', 'de': 'Weiter'},
    'ucitavanje': {'sr': 'Učitavanje...', 'en': 'Loading...', 'ru': 'Загрузка...', 'de': 'Wird geladen...'},
    'prijavaBiometrijom': {
    ...
    'ime': {'sr': 'Ime', 'en': 'First name', 'ru': 'Имя', 'de': 'Vorname'},
    'prezime': {'sr': 'Prezime', 'en': 'Last name', 'ru': 'Фамилия', 'de': 'Nachname'},
    'kategorija': {'sr': 'Kategorija', 'en': 'Category', 'ru': 'Категория', 'de': 'Kategorie'},
    'izaberiteKategoriju': {
    ...
    'dnevni': {'sr': '📅 Dnevni', 'en': '📅 Daily', 'ru': '📅 Ежедневно', 'de': '📅 Täglich'},
    'posiljka': {'sr': '📦 Pošiljka', 'en': '📦 Parcel', 'ru': '📦 Посылка', 'de': '📦 Paket'},
    'adresaBc': {'sr': 'Adresa BC *', 'en': 'BC address *', 'ru': 'Адрес БЦ *', 'de': 'BC-Adresse *'},
    'adresaVs': {'sr': 'Adresa VS *', 'en': 'VS address *', 'ru': 'Адрес ВС *', 'de': 'VS-Adresse *'},
    'noviPin': {
    ...
    'adresaBcKratko': {'sr': 'adresa BC', 'en': 'BC address', 'ru': 'адрес БЦ', 'de': 'BC-Adresse'},
    'adresaVsKratko': {'sr': 'adresa VS', 'en': 'VS address', 'ru': 'адрес ВС', 'de': 'VS-Adresse'},
    'pinKod': {'sr': 'PIN kod', 'en': 'PIN code', 'ru': 'PIN-код', 'de': 'PIN-Code'},
    'tip': {'sr': 'tip', 'en': 'category', 'ru': 'категория', 'de': 'Kategorie'},
    'dopunitePolja': {'sr': 'Dopunite', 'en': 'Please complete', 'ru': 'Дополните', 'de': 'Bitte ergänzen'},
    'daNastavite': {'sr': 'da nastavite.', 'en': 'to continue.', 'ru': 'чтобы продолжить.', 'de': 'um fortzufahren.'},
    'dopuniteObavezna': {
    ...
    'imeKratko': {'sr': 'ime', 'en': 'name', 'ru': 'имя', 'de': 'Name'},
    'kategorijuKratko': {'sr': 'kategoriju', 'en': 'category', 'ru': 'категорию', 'de': 'Kategorie'},
    'deviceLimitReached': {
