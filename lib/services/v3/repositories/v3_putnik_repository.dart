...
class V3PutnikRepository {
  static const String _legacyPutnikSelect =
      'id:auth_id, ime_prezime:ime, telefon_1:telefon, telefon_2, tip_putnika:tip, adresa_bc_id, adresa_vs_id, adresa_bc_id_2, adresa_vs_id_2, cena_po_danu, cena_po_pokupljenju, push_token, push_token_2, aktivno, created_at, updated_at';
  ...
  Future<Map<String, dynamic>?> getActiveById(String id) {
    return supabase.from('v3_auth').select(_legacyPutnikSelect).eq('auth_id', id).eq('aktivno', true).maybeSingle();
  }
