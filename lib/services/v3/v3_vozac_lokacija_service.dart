...
class V3VozacLokacijaService {
  ...
  /// This is called frequently (e.g., every 5-10 seconds) during active transit.
  static Future<void> updateLokacija(V3VozacLokacijaUpdate update) async {
    try {
      // V3 Arhitektura: Fire and Forget.
      // Upsert based on vozac_id ensures we only have one row per driver in the live table.
