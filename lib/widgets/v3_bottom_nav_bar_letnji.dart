...
class V3BottomNavBarLetnji extends StatefulWidget {
  ...
  @override
  State<V3BottomNavBarLetnji> createState() => _BottomNavBarLetnjiState();
}

class _BottomNavBarLetnjiState extends State<V3BottomNavBarLetnji> {
  ...
  @override
  void didUpdateWidget(V3BottomNavBarLetnji oldWidget) {
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: vremena.map((vreme) {
                  ...
                  final selectedStrokeAndTextColor = _selectedStrokeAndTextColor();
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          ...
                          color: hasVozac
                              ...
                              : selected
                                  ? selectedStrokeAndTextColor.withOpacity(0.8)
                                  : Colors.grey[300]!,
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: selected ? selectedStrokeAndTextColor : Colors.white,
                            ),
                          ),
