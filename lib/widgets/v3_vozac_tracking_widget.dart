...
class V3VozacTrackingWidget extends StatefulWidget {
  ...
  @override
  State<V3VozacTrackingWidget> createState() => _V3VozacTrackingWidgetState();
}

class _V3VozacTrackingWidgetState extends State<V3VozacTrackingWidget> {
  // ETA подaci
  int? _etaMinutes;
  ...
  @override
  void dispose() {
    V3StreamUtils.cancelSubscription('vozac_tracking_location_for_putnik');
    super.dispose();
  }
  ...
  void _startTracking() {
    ...
    V3StreamUtils.subscribe<void>(
        key: 'vozac_tracking_location_for_putnik',
