...
const Map<String, Map<String, Map<String, String>>> _screensB = {
  ...
  'putnikProfilScreenProfileDialogT': {
    ...
    'azurirajImeTel': {
      'sr': 'Ažuriraj ime, telefon i stalne adrese',
      'en': 'Update name, phone and permanent addresses',
      'ru': 'Обновите имя, телефон и постоянные адреса',
      'de': 'Name, Telefon und feste Adressen aktualisieren',
      'zh': '更新姓名、电话和固定地址',
    },
    'imePrezime': {
      'sr': 'Ime i prezime',
    ...
    'stalneAdrese': {
      'sr': 'Stalne adrese',
      'en': 'Permanent addresses',
      'ru': 'Постоянные адреса',
      'de': 'Feste Adressen',
      'zh': '固定地址',
    },
    'adreseBc': {
    ...
    'obavezneAdrese': {
      'sr': '⚠️ Odaberi glavnu BC i VS adresu',
      'en': '⚠️ Select main BC and VS address',
      'ru': '⚠️ Выберите основной адрес BC i VS',
      'de': '⚠️ Hauptadresse BC und VS auswählen',
      'zh': '⚠️ 请选择主要 BC 和 VS 地址',
    },
  ...
  'smsLoginScreen': {
    ...
    'noviPin': {
      'sr': 'Sami smislite PIN kod (6 cifara) *',
      'en': 'Create your own PIN code (6 digits) *',
      'ru': 'Придумайте свой PIN-код (6 цифр) *',
      'de': 'Legen Sie selbst eine PIN fest (6 Ziffern) *',
      'zh': '请自行设置PIN码（6位数字）*',
    },
    'unesitePin': {
  ...
  'vozacScreen': {
    ...
    'hereWeGoInstallTitle': {
      'sr': 'Za GPS navigaciju instalirajte HERE WeGo. Bez te aplikacije navigacija nije dostupna.',
      'en': 'Install HERE WeGo for GPS navigation. Navigation is unavailable without that app.',
      'ru': 'Для GPS-навигации установите HERE WeGo. Без этого приложения навигация недоступна.',
      'de': 'Installieren Sie HERE WeGo für die GPS-Navigation. Ohne diese App ist Navigation nicht verfügbar.',
      'zh': '请安装 HERE WeGo 以使用 GPS 导航。未安装则无法导航。',
    },
    ...
    'mapaNijeOtvorena': {
      'sr': 'HERE WeGo nije otvoren. Proverite da li je aplikacija instalirana.',
      'en': 'HERE WeGo did not open. Check that the app is installed.',
      'ru': 'HERE WeGo не открылся. Проверьте, установлено ли приложение.',
      'de': 'HERE WeGo wurde nicht geöffnet. Prüfen Sie, ob die App installiert ist.',
      'zh': 'HERE WeGo 未能打开。请确认应用已安装。',
    },
    'rutaPripremljena': {
    ...
    'autoStartPauzirajMeni': {
      'sr': 'Pauziraj auto-start danas',
      'en': 'Pause auto-start today',
      'ru': 'Пауза автозапуска сегодня',
      'de': 'Autostart heute pausieren',
      'zh': '今日暂停自动启动',
    },
    'autoStartUkljuciMeni': {
      'sr': 'Uključi auto-start',
      'en': 'Enable auto-start',
      'ru': 'Включить автозапуск',
      'de': 'Autostart aktivieren',
      'zh': '启用自动启动',
    },
    'autoStartPauziranDanas': {
      'sr': 'Auto-start pauziran za danas.',
      'en': 'Auto-start paused for today.',
      'ru': 'Автозапуск приостановлен на сегодня.',
      'de': 'Autostart für heute pausiert.',
      'zh': '今日已暂停自动启动。',
    },
    'autoStartUkljucen': {
      'sr': 'Auto-start ponovo uključen.',
      'en': 'Auto-start enabled again.',
      'ru': 'Автозапуск снова включён.',
      'de': 'Autostart wieder aktiv.',
      'zh': '自动启动已重新启用。',
    },
    'temaPromenjena': {
      'sr': '🎨 Tema promenjena',
