...
const Map<String, Map<String, Map<String, String>>> _screensA = {
  'adminRasporedScreen': {
    ...
    'terminLabel': {'sr': 'SLOT', 'en': 'SLOT', 'ru': 'СЛОТ', 'de': 'SLOT', 'zh': '时段'},
    'dodeliVozacaTerminu': {
      'sr': 'Dodeli vozača slotu',
      'en': 'Assign driver to slot',
      'ru': 'Назначить водителя на слот',
      'de': 'Fahrer dem Slot zuweisen',
      'zh': '将司机分配到时段',
    },
    'ukloniDodeluTermina': {
      'sr': 'Ukloni dodelu slota',
      'en': 'Remove slot assignment',
      'ru': 'Удалить назначение слота',
      'de': 'Slot-Zuweisung entfernen',
      'zh': '移除时段分配',
    },
  ...
  'vozacPozicijaScreen': {
    'naslov': {
      'sr': '🛰️ Pozicija vozača',
      'en': '🛰️ Driver position',
      'ru': '🛰️ Позиция водителя',
      'de': '🛰️ Fahrerposition',
      'zh': '🛰️ 司机位置',
    },
    'izaberiVozaca': {
    ...
    'izaberiVozacaHint': {
      'sr': 'Izaberi vozača da vidiš njegovu poziciju.',
      'en': 'Select a driver to see their position.',
      'ru': 'Выберите водителя, чтобы увидеть его позицию.',
      'de': 'Wähle einen Fahrer, um seine Position zu sehen.',
      'zh': '选择一名司机以查看其位置。',
    },
    'cekaSePozicija': {
      'sr': 'Čeka se pozicija vozača (mora imati aktivan tracking)...',
      'en': 'Waiting for driver position (tracking must be active)...',
      'ru': 'Ожидание позиции водителя (отслеживание должно быть активным)...',
      'de': 'Warte auf Fahrerposition (Tracking muss aktiv sein)...',
      'zh': '等待司机位置（必须启用追踪）...',
    },
    'azurirano': {
      'sr': 'Ažurirano',
  ...
  'finansijeScreen': {
    ...
    'dugZaGorivo': {
      ...
      'en': 'Fuel debt',
      'ru': 'Долг за топливо',
      'de': 'Kraftstoffschulden',
      'zh': '燃油欠款',
    },
    'neizmireniDugoviZaGorivo': {
      'sr': 'Ukupan dug dobavljaču (sve isporuke + stari dug). Uplata skida sa ovog broja.',
      'en': 'Total supplier debt (all deliveries + old debt). Payment reduces this amount.',
      'ru': 'Общий долг поставщику (все поставки + старый долг). Оплата уменьшает эту сумму.',
      'de': 'Gesamtschuld beim Lieferanten (alle Lieferungen + alte Schuld). Zahlung mindert diesen Betrag.',
      'zh': '供应商总欠款（全部交货+旧欠）。付款从此金额扣减。',
    },
    'gorivoUplataHint': {
      'sr': 'Uplata skida sa ukupnog duga. Više od duga → dug 0. Manje → ostaje razlika.',
      'en': 'Payment reduces total debt. More than debt → debt 0. Less → remainder stays.',
      'ru': 'Оплата уменьшает общий долг. Больше долга → 0. Меньше → остаток остаётся.',
      'de': 'Zahlung mindert Gesamtschuld. Mehr als Schuld → 0. Weniger → Rest bleibt.',
      'zh': '付款扣总欠。多于欠款→归零。少于→保留差额。',
    },
    ...
    'katYuAuto': {'sr': 'YU Auto', 'en': 'YU Auto', 'ru': 'YU Auto', 'de': 'YU Auto', 'zh': 'YU Auto'},
    'katMajstori': {'sr': 'Majstori', 'en': 'Mechanics', 'ru': 'Мастера', 'de': 'Mechaniker', 'zh': '技工'},
    'katPorez': {'sr': 'Porez', 'en': 'Tax', 'ru': 'Налог', 'de': 'Steuer', 'zh': '税'},
    'katAlimentacija': {
      'sr': 'Alimentacija',
      'en': 'Alimony',
      'ru': 'Алименты',
  ...
  'kapacitetScreen': {
    ...
    'vrsac': {'sr': 'Vršac', 'en': 'Vršac', 'ru': 'Вршац', 'de': 'Vršac', 'zh': 'Vrsac'},
    'greskaPriCuvanju': {
      'sr': '❌ Greška pri čuvanju',
      'en': '❌ Error saving',
      'ru': '❌ Ошибка при сохранении',
