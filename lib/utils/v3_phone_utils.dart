...
class V3PhoneUtils {
  ...
  static String normalize(String phone) {
    ...
    if (p.startsWith('+3810')) return '+381${p.substring(5)}'; // +3810...
    if (p.startsWith('+381')) return p; // već +381
    if (p.startsWith('003810')) return '+381${p.substring(6)}'; // 003810...
    if (p.startsWith('00381')) return '+381${p.substring(5)}'; // 00381...
    if (p.startsWith('3810')) return '+381${p.substring(4)}'; // 3810...
