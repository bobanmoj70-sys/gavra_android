...
class V3WelcomeMessages {
  ...
  static const String profileNotFoundForPhone =
      '❌ Profil nije pronađen za ovaj broj.';
}

class V3PutnikProfilMessages {
  V3PutnikProfilMessages._();

  static const String invalidTermTime =
      '⚠️ Neispravno vreme termina. Pokušajte ponovo.';
  ...
  static const String requestPendingDispatcher =
      'Vaš zahtev je u obradi kod dispečera.';
  static const String alreadyPickedUp =
      '🚗 Već ste pokupljeni — nije moguće otkazati.';
  static const String logoutSuccess = '✅ Uspešno odjavljeni';
  static const String themeChanged = '🎨 Tema promenjena';

  static String tripCanceled(String dan, String grad) =>
      '✅ Polazak otkazan: $dan $grad';

  static String nonWorkingDay(String datumIso, String reason) =>
      '⛔ Neradan dan ($datumIso). Razlog: $reason';

  static String dnevniDateWindowLocked(String allowedLabel) =>
      'ℹ️ Zbog ograničenog broja mesta i bolje optimizacije kapaciteta, za vaš tip putnika trenutno je moguće zakazivanje samo za $allowedLabel. Hvala na razumevanju.';
