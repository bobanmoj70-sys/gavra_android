...
// V3AppSnackBar.warning(context, '⏳ Zahtev je u obradi...');
// V3AppSnackBar.info(context, 'ℹ Rezervacije su moguće samo za danas i sutra.');
// KRAJ SPECIFIKACIJE

class V3AppSnackBar {
  V3AppSnackBar._(); // Ne instancirati
