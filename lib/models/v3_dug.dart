...
class V3Dug {
  ...
  factory V3Dug.fromJson(Map<String, dynamic> json) {
    return V3Dug(
      ...
      pokupljenAt: V3BelgradeTime.parseTs(json['pokupljen_at']?.toString()),
      ...
      naplacenoAt: V3BelgradeTime.parseTs(json['naplaceno_at']?.toString()),
  ...
  Map<String, dynamic> toJson() => {
        ...
        'iznos': iznos,
        'placeno': placeno,
        if (createdAt != null) 'created_at': V3BelgradeTime.toIsoUtc(createdAt!),
        if (naplacenoAt != null) 'naplaceno_at': V3BelgradeTime.toIsoUtc(naplacenoAt!),
