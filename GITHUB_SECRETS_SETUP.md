...
6. **ANDROID_AGCONNECT_SERVICES_JSON_BASE64**
   - Vrijednost: Vidi `temp_secrets/ANDROID_AGCONNECT_SERVICES_JSON_BASE64.txt`

7. **GOOGLE_PLAY_SERVICE_ACCOUNT_JSON_BASE64**
...
12. **IOS_ENV**
    - Vrijednost: Vidi `temp_secrets/IOS_ENV.txt`
