 ...
 *
 * Odgovornosti:
 * 1. onMessageReceived — app je u FOREGROUND-u ili BACKGROUND-u:
 ...
 *    → ako engine NIJE aktivan (background): prikazuje nativnu Android notifikaciju
 ...
 *
 * NAPOMENA: vozac_auto_start_tracking se više NE pokreće automatski kada je app
 * killed. Korisnik mora da otvori app da bi tracking krenuo.
 */
class GavraFcmService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (engine != null) {
            ...
            // Za data-only poruke prikaži nativnu Android notifikaciju.
