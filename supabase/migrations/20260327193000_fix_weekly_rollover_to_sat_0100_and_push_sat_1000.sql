-- Follow-up fix:
-- - rollover treba da bude subota 01:00 (petak na subotu)
-- - push podsetnik putnicima treba da bude subota 10:00
...
BEGIN
  ...
  INSERT INTO public.v3_weekly_rollover_runs (
    ...
    v_copied_slots,
    0,
    'rollover_done_push_separate_sat_1000'
  )
...
DECLARE
  v_job integer;
BEGIN
  SELECT jobid INTO v_job FROM cron.job WHERE jobname = 'weekly-rollover-fri-0100-belgrade' LIMIT 1;
...
-- SELECT * FROM cron.job WHERE jobname in ('weekly-rollover-sat-0100-belgrade','weekly-reservation-reminder-sat-1000');
